...
class Tenant
{
    private const string ENDPOINT = '/tenancy/tenants/';

    // Writable fields
    private ?string $id = null;
    private string $name = '';
    private string $slug = '';
    private ?string $group = null; // TenantGroup id
    ...
    public function add(): void
    {
        if (empty($this->getName())) {
            throw new Exception("Missing name for Tenant");
        }
        if (empty($this->getSlug())) {
            throw new Exception("Missing slug for Tenant");
        }
    ...
    public function load(): void
    {
        ...
        if (empty($params)) {
            throw new Exception("Can't load Tenant without 'id', 'name', or 'slug'");
        }
        ...
        if (($res['count'] ?? 0) > 1) {
            throw new Exception("Multiple Tenants returned by query");
        }
    ...
    /**
     * List all tenants in a specific group
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't edit Tenant without 'id'");
        }
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't update Tenant without 'id'");
        }
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't delete Tenant without 'id'");
        }
    ...
    private function loadFromApiResult(array $res): void
    {
        ...
        $this->ipaddress_count = isset($res['ipaddress_count']) ? (int)$res['ipaddress_count'] : null;
        ...
        $this->site_count = isset($res['site_count']) ? (int)$res['site_count'] : null;
        ...
        $this->vrf_count = isset($res['vrf_count']) ? (int)$res['vrf_count'] : null;
    ...
    public function setId(?string $id): Tenant { $this->id = $id; return $this; }

    public function getName(): string { return $this->name; }
    public function setName(string $name): Tenant { $this->name = $name; return $this; }

    public function getSlug(): string { return $this->slug; }
    public function setSlug(string $slug): Tenant { $this->slug = $slug; return $this; }

    public function getGroup(): ?string { return $this->group; }
    public function setGroup(?string $group): Tenant { $this->group = $group; return $this; }

    public function getDescription(): string { return $this->description; }
    public function setDescription(string $description): Tenant { $this->description = $description; return $this; }

    public function getOwner(): ?string { return $this->owner; }
    public function setOwner(?string $owner): Tenant { $this->owner = $owner; return $this; }

    public function getComments(): string { return $this->comments; }
    public function setComments(string $comments): Tenant { $this->comments = $comments; return $this; }

    public function getTags(): array { return $this->tags; }
    public function setTags(array $tags): Tenant { $this->tags = $tags; return $this; }

    public function getCustomFields(): array { return $this->custom_fields; }
    public function setCustomFields(array $custom_fields): Tenant { $this->custom_fields = $custom_fields; return $this; }
    ...
    public function getIpaddressCount(): ?int { return $this->ipaddress_count; }
    public function getPrefixCount(): ?int { return $this->prefix_count; }
    public function getRackCount(): ?int { return $this->rack_count; }
    public function getSiteCount(): ?int { return $this->site_count; }
    ...
    public function getVrfCount(): ?int { return $this->vrf_count; }
