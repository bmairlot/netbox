...
class ClusterGroup
{
    private const string ENDPOINT = '/virtualization/cluster-groups/';
    ...
    public function add(): void
    {
        if (empty($this->getName())) {
            throw new Exception("Missing name for ClusterGroup");
        }
        if (empty($this->getSlug())) {
            throw new Exception("Missing slug for ClusterGroup");
        }
    ...
    public function load(): void
    {
        ...
        if (empty($params)) {
            throw new Exception("Can't load ClusterGroup without 'id', 'name' or 'slug'");
        }

        $res = self::$client->get(self::ENDPOINT, $params);

        if (($res['count'] ?? 0) === 0) {
            throw new Exception("ClusterGroup not found");
        }
        if (($res['count'] ?? 0) > 1) {
            throw new Exception("Multiple ClusterGroups returned by query");
        }
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't edit ClusterGroup without 'id'");
        }
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't update ClusterGroup without 'id'");
        }
    ...
    {
        if (is_null($this->getId())) {
            throw new Exception("Can't delete ClusterGroup without 'id'");
        }
    ...
    public function setId(?string $id): ClusterGroup { $this->id = $id; return $this; }

    public function getName(): string { return $this->name; }
    public function setName(string $name): ClusterGroup { $this->name = $name; return $this; }

    public function getSlug(): string { return $this->slug; }
    public function setSlug(string $slug): ClusterGroup { $this->slug = $slug; return $this; }

    public function getDescription(): string { return $this->description; }
    public function setDescription(string $description): ClusterGroup { $this->description = $description; return $this; }

    public function getComments(): string { return $this->comments; }
    public function setComments(string $comments): ClusterGroup { $this->comments = $comments; return $this; }

    public function getOwner(): ?string { return $this->owner; }
    public function setOwner(?string $owner): ClusterGroup { $this->owner = $owner; return $this; }

    public function getTags(): array { return $this->tags; }
    public function setTags(array $tags): ClusterGroup { $this->tags = $tags; return $this; }

    public function getCustomFields(): array { return $this->custom_fields; }
    public function setCustomFields(array $custom_fields): ClusterGroup { $this->custom_fields = $custom_fields; return $this; }
